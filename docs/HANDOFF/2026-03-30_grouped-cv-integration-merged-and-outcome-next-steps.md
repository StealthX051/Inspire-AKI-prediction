...
- `justin`
  - remote status: merge target and stable refactor line
  - role: active main line after merging the outcome extension
- `outcome-extension`
  - remote status: safety source branch preserved after merge
  - role: recovery/reference branch
  - note: contains the last pre-merge standalone outcome-extension tip that was merged into `justin`
- `cv-integration-aki`
