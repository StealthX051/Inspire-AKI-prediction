...
from sklearn.metrics import average_precision_score as aucprc
...
# RESULTS_FILE_PATH = '/home/server/Projects/data/Multiple-Outcomes/results/tabular_hpo_results.txt'
...
def save_hpo_results_to_file(filepath, results_dict):
    """
    Saves the final HPO results to a JSON file.
    """
...
def main():
    ...
    for TARGET in TARGETS:
        RESULTS_FILE_PATH = f'/home/server/Projects/data/Multiple-Outcomes/results/tabular_hpo_results_{TARGET}.txt'
        for dataset_info in datasets_to_run:
            ...
            def get_objective_function(model_name):
                def objective_log_reg(trial):
                    ...
                    return aucprc(y_val, model.predict_proba(X_val_scaled)[:, 1])
                ...
                def objective_svm(trial):
                    ...
                    model.fit(X_train_scaled, y_train)
                    return aucprc(y_val, model.decision_function(X_val_scaled))
